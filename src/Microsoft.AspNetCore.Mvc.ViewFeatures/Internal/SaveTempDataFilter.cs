    ...
    public class SaveTempDataFilter : IResourceFilter, IResultFilter
    {
        ...
        public void OnResultExecuting(ResultExecutingContext context)
        {
            context.HttpContext.Response.OnStarting((state) =>
            {
                ...
                // If temp data was already saved, skip trying to save again as the calls here would potential fail
                ...
                var tempDataSaved = saveTempDataContext.HttpContext.Items["TempDataSaved"] == null ? false : true;
                if (tempDataSaved)
                {
        ...
        public void OnResultExecuted(ResultExecutedContext context)
        {
            ...
            if (!context.HttpContext.Response.HasStarted)
            {
                ...
                context.HttpContext.Items["TempDataSaved"] = true;
            }
        }
